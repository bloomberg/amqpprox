...
class Consumer(object):
    ...
    def connect(self):
        ...
        When the connection is established, the o_connection_open method
    ...
    def on_connection_closed(self, _, reply_text):
        ...
        LOGGER.warning('Connection closed : %s', reply_text)
...
def main():
    ...
    example = Consumer('amqp://guest:guest@localhost:5555/')
    try:
        example.run()
