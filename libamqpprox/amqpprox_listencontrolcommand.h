...
*/
#ifndef BLOOMBERG_AMQPPROX_LISTENCONTROLCOMMAND
#define BLOOMBERG_AMQPPROX_LISTENCONTROLCOMMAND
...
/**
 * \brief Control command to start/stop AMQP traffic on a certain port,
 * implements the ControlCommand interface
 */
class ListenControlCommand : public ControlCommand {
  public:
    ListenControlCommand();
