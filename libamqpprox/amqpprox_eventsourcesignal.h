...
class EventSourceSignal : public EventSourceSignalBase {
  ...
  public:
    ...
    ///< Subscribe a callback to receive notifications for this event
    ///< and return an object that when it goes out of scope will remove
    ///< the subscription from this signal.
    {
    ...
    ///< Explicitly remove the subscription for this signal, this is a
    ...
    void emit(ARGS... args)
    ///< Emit the event to all subscribed handlers
    {
