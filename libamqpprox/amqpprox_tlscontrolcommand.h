...
*/
#ifndef BLOOMBERG_AMQPPROX_TLSCONTROLCOMMAND
#define BLOOMBERG_AMQPPROX_TLSCONTROLCOMMAND
...
/**
 * \brief Control command to configure proxy to use TLS for ingress (server)
 * and egress (client) connections, implements the ControlCommand interface
 */
class TlsControlCommand : public ControlCommand {
  public:
    TlsControlCommand();
